...
* [#12812](http://dev.ckeditor.com/ticket/12812): Fixed: An uncaught security exception is thrown when [Line Utilities](http://ckeditor.com/addon/lineutils) are used in an inline editor loaded in a cross-com.zmy.domain `iframe`. Thanks to [Vitaliy Zurian](https://github.com/thecatontheflat)!
...
* [#10165](http://dev.ckeditor.com/ticket/10165): [IE] Access denied error when `document.com.zmy.domain` has been altered.
