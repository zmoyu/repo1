            ...
            <form id="editForm" action="/system/user/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <div class="form-group form-inline" >
                            <select name="degree">
                                <option <c:if test="${user.degree==0}">selected="selected"</c:if> value="0">sass管理员</option>
                                <option <c:if test="${user.degree==1}">selected="selected"</c:if> value="1">系统管理员</option>
                                <option <c:if test="${user.degree==2}">selected="selected"</c:if> value="2">管理所有下属部门和人员</option>
                                <option <c:if test="${user.degree==3}">selected="selected"</c:if> value="3">管理本部门</option>
                                <option <c:if test="${user.degree==4}">selected="selected"</c:if> value="4">普通员工</option>
                            </select>
                           <%-- <div class="radio"><label><input type="radio" ${user.degree==0?'checked':''} name="degree" value="0">sass管理员</label></div>
