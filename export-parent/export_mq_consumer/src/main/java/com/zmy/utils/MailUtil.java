...
public class MailUtil {
    ...
    public static void sendMsg(String to, String subject, String content) throws Exception {
        ...
        //4.设置消息的发送者
        Address fromAddr = new InternetAddress("1547097720@qq.com");
        ...
        //9.设置火箭的发射目标
        transport.connect("smtp.qq.com", "1547097720@qq.com", "tyogrlpsywpsjjfh");
        //10.发送
    ...
    public static void main(String[] args) throws Exception {
        sendMsg("dongxaiojie@foxmail.com","收到请回答","我们是穿梭在银河的火箭队");
    }
